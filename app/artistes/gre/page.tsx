...
export default function drpaco() {
  const artiste = {
    nom: "GRE",
    image: "/gre.jpg", // à remplacer

    soundcloud: "https://on.soundcloud.com/RHXikyNHAOKbJKXL3d",
    instagram: "https://www.instagram.com/gre_okuma?utm_source=ig_web_button_share_sheet&igsh=eXVyY2Z5OGM4ZG03",
...
Artiste et activiste de la scène Tekno française depuis une vingtaine d’années, Gre a fait ses armes avec le live, et s’est plus tard orienté vers le Djing, Influencé par la musique rave des Spiral Tribe, de Fky, Gotek et beaucoup d’autres.
Il joue une tekno psychédelique, tribale et rythmique, progressive, sans en oublier le groove. En 2014, il fonde le label Okuma Records avec Kuluk, s’en suivront de nombreux releases vinyles et digitaux joués dans tout l’Europe.
