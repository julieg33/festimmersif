...
export default function Stoat() {
  const artiste = {
    nom: "Stoat",
    image: "/stoat.jpg", // à remplacer

    soundcloud: "https://on.soundcloud.com/tmGKDup9PeuvHt6fVZ",
    instagram: "https://www.instagram.com/__stoat__?utm_source=ig_web_button_share_sheet&igsh=MXB6Z2l2dGttaDh2dA==",
...
Artiste pluridisciplinaire, Stoat est avant tout tatoueuse. C'est avec la décoration et l'équipe de Cosmo Vision qu'elle fit ses premières armes dans le monde de la fête, notamment auprès des Kristal Sphere et du BT59. 
      </p>
         <p className="text-lg font-quantico leading-relaxed mb-6">
Exploratrice des rythmes nocturnes et passionnée de Techno, elle s'aventure derrière les platines depuis quelques années maintenant en voguant de la Tech House à la Techno mentale entres autres influences. De l'ombre à la lumière, c'est avec sensualité et un sens inégalé du groove que cette recrue du Dark Side of the Line enflamme désormais la plupart des dancefloors de la ville de Bordeaux. 
      </p>
