...
passion pour les sonorités puissantes alliées à des rythmes breakés est née.
C’est en 2010, après plusieurs années de guitare, et sous l’effet d’une bombe nommée NOISIA, qu’il décide d’apprendre la M.A.O, Dub, Dubstep et Drum n’ bass sont alors ses armes favorites. Plus tard, il découvre les free party et les artistes qui y sont associés : Mr Gasmask, Enko, Sevenum six, et bien d’autres...
C’est alors en puisant dans cette variété d’influences et en cherchant à les mélanger, qu’il crée sa signature hybride. Avec des rythmes allant de la Tribe à la d’n’b, et des basses allant de l’Acid à la Neuro.
`,
    soundcloud: "https://on.soundcloud.com/WYeCufHlHxxxB8ytZw",
    instagram: "https://www.instagram.com/piou.shz?utm_source=ig_web_button_share_sheet&igsh=MWg5OGZhNzVhZWp1dw==",
...
<main className="flex-grow pt-20 sm:pt-24 lg:pt-28">
  ...
  <div className="max-w-screen-xl mx-auto flex flex-col lg:flex-row items-center gap-12 px-4 sm:px-6 lg:px-8">
    ...
    <div className="w-full lg:w-2/3 text-center lg:text-left">
      ...
      <p className="text-lg font-quantico leading-relaxed mb-6">{artiste.bio}</p>
