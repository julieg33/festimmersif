...
export default function Catharso() {
  const artiste = {
    nom: "Catharso",
    image: "/catharso.jpg", // à remplacer

    soundcloud: "https://on.soundcloud.com/Zih9WMH0ItCU8Ory05",
...
Catharso, de son vrai nom Ugo, est un personnage hybride dont l'univers est un grand mélange de ce qui l'anime.
Bercé par Pink Floyd, nourri par Square Pusher, motivé par Noisia ou encore Habstakt, il surfe très tôt sur la vague underground de la musique. Mélomane, batteur et descendant d'une lignée de fêtards, Catharso fait vivre son univers avec des tonalités tantôt house, tantôt techno, en passant bien évidemment par la bass music.
Cela dit, il n'est pas exclu qu'une touche de psychédélisme fasse son apparition durant son set.
    </p>
