...
export default function drpaco() {
  const artiste = {
    nom: "DR Paco",
    image: "/drpaco.png", // à remplacer

    soundcloud: "https://on.soundcloud.com/03cdkuCXXGB4r6Vlhw",
    instagram: "https://www.instagram.com/paco.idtk?utm_source=ig_web_button_share_sheet&igsh=enF2MTFxM2JsYXlz",
...
Passionné de musique en tout genre depuis petit, il décide à son tour d'en produire. C'est en 2020 que l'histoire commence avec sa première groovebox.
Depuis DR. PACO mène ses opérations sur le cerveau de ses patients à l'aide de boucles étranges et envoûtantes sur un rythme tribal rondement mené.


      </p>
            <p className="text-lg font-quantico leading-relaxed mb-6">
Au menu ?
Un live tribe mental accompagné de notes acidulées.
