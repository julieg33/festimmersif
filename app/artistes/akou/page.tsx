...
export default function Akou() {
  const artiste = {
    nom: "Akou",
    image: "/akou.jpg", // à remplacer

    soundcloud: "https://on.soundcloud.com/lqlyys4AJUatfe8vJv",
    instagram: "https://www.instagram.com/a.k_o.u?utm_source=ig_web_button_share_sheet&igsh=MTRrOW9yMng2c2ZiZA==",
  ...
  <div className="max-w-screen-xl mx-auto flex flex-col lg:flex-row items-center gap-12 px-4 sm:px-6 lg:px-8">
    ...
    <div className="w-full lg:w-2/3 text-center lg:text-left">
      ...
      <p className="text-lg font-quantico leading-relaxed mb-6">
        Akou est un jeune artiste marseillais qui tire ses inspirations de la scène tekno actuelle, ainsi que de nombreux autres styles de musique électroniques, mais aussi du reggae/dub. 
Sa diversité et la rigueur de son travail lui ont permis de progresser rapidement.
Il propose depuis début 2023 des performances live sur Ableton, divisées entre un groove percutant et des mélodies et ambiances intrigantes. 
      </p>
      <p className="text-lg font-quantico leading-relaxed mb-6">
        Cet artiste ne cesse de se renouveler, d’innover et d’expérimenter des nouvelles idées, de plus il fait preuve d’une grande productivité.
Ses principaux objectifs sont de faire voyager ses auditeurs, de créer des sourires et des souvenirs marquants.
