...
export default function Primabot() {
  const artiste = {
    nom: "Primabot",
    image: "/primabot.jpg", // à remplacer

    soundcloud: "https://on.soundcloud.com/hhDKozYBeraHuwskD8",
    instagram: "https://www.instagram.com/primabot.gamil?utm_source=ig_web_button_share_sheet&igsh=MmtqZ3ptOXVyMXF5",
...
Primabot est un artiste, musicien, producteur et compositeur professionnel basé à Lyon (France).
Son projet, né en 2019, est parfait pour des performances psychédéliques et extatiques avec un public de passionnés de culture psyché.

    </p>
             <p className="text-lg font-quantico leading-relaxed mb-6">
Primabot est un artiste, musicien, producteur et compositeur professionnel basé à Lyon (France).
Son projet, né en 2019, est parfait pour des performances psychédéliques et extatiques avec un public de passionnés de culture psyché.
Distillant sa musique entre 100 et 120 bpm, elle consiste en un blend unique de glitchs surfant sur des lignes de basses lourdes et hypnotiques. Inspiré par la Psy trance Progressive avec des influences Tech, mais également la Synth Wave ou la Techno, ses compositions passent par de multiples stades variant en énergie et en émotion.
Tantôt mélancolique et profondément minimaliste, sa musique peut atteindre des pics d'intensité forts, avec une énergie puissante. Il performe de la Guitare en live, du Clavier ainsi que des Percussions pendant son show.

    </p>
                 <p className="text-lg font-quantico leading-relaxed mb-6">
Depuis 2019, il a produit pas moins de 18 tracks avec patience, méthode et précision. Certains de ces titres sont sortis sur des labels de renommée internationale tels que : Altar Records (CANADA) ou Astral Vision Records (MEXICO). 
Il est également le co-fondateur du label Lyonnais Multiversal Records-MVR et aussi membre et artiste du label Grenoblois ADN MUSIC. Il a performé plus d'une vingtaine de fois avec ce projet sur des scènes de tailles variables en plus d'avoir joué pendant de nombreuses années en groupe de musique en tant que Guitariste, Batteur ou encore Chanteur.
Ce qu'on peut dire c'est que Primabot possède une solide expérience de scène et du spectacle, notamment en donnant le maximum d'énergie lors de ces lives. Il aime rendre les choses différentes, originales et non génériques.
