...
export default function Hugo() {
  const artiste = {
    nom: "Totemïk Anïgua",
    image: "/totemikanigua.jpg", // à remplacer
    soundcloud: "https://on.soundcloud.com/p5jztWqBoORIlPoPFJ",
...
<main className="flex-grow pt-20 sm:pt-24 lg:pt-28">
  ...
  <div className="max-w-screen-xl mx-auto flex flex-col lg:flex-row items-center gap-12 px-4 sm:px-6 lg:px-8">
    ...
    <div className="w-full lg:w-2/3 text-center lg:text-left">
      ...
      <p className="text-lg font-quantico leading-relaxed mb-6">Totemik Anigua baigne dans la musique depuis l’enfance, commençant par la batterie, la guitare et d’autres instruments avant de plonger dans la production électronique sur Ableton.
 Son univers sonore — une fusion de textures psychédéliques, ambiantes et groovy, enrichie d’acid et de mélodies fluides — reflète sa vision intérieure : paysages mentaux, éclats de couleurs et secrets enfouis. </p>
      <p className="text-lg font-quantico leading-relaxed mb-6">Profondément inspiré par le mouvement free party, Totemik Anigua puise dans l’énergie brute et spirituelle de la teknoet de l’acidcore, façonnant sa musique comme un moyen de partager son lien avec la voix mystique de la nature. À travers ses morceaux, il invite l’auditeur à plonger dans un monde d’émotions brutes et de liberté créative.</p>
