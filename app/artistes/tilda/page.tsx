...
export default function Tilda() {
  const artiste = {
    nom: "Tilda",
    image: "/tilda.jpg", // à remplacer

    soundcloud: "https://on.soundcloud.com/nHvZgedturLca5ng1f",
    instagram: "https://www.instagram.com/tilda.music?utm_source=ig_web_button_share_sheet&igsh=MWRsMHoyd3Ryb2g3Yw==",
