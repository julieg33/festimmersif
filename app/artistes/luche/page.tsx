...
export default function Luche() {
  const artiste = {
    nom: "Luche",
    image: "/luche.jpg", // à remplacer

    soundcloud: "https://on.soundcloud.com/7S9tpA2kxVvfDKWoXG",
    instagram: "https://www.instagram.com/luche_wp?utm_source=ig_web_button_share_sheet&igsh=NmFkZWZ1bGowMnRq",
...
A mi-chemin entre acid-tekno et trance, Luche développe un univers hybrid où les TB-303 semblent communiquer.
Le son acid, un langage que l’artiste nantais apprend tout d’abord dans le milieu free party, théâtre de ses premiers lives et de ses premières impulsions créatrices. Faisant rapidement ses preuves face à des sound systems démesurés, sa musique trouve alors le chemin des clubs, des festivals, et s’enrichit sur sa route de nouvelles esthétiques : trance, goa... Des sonorités qui viennent élargir son spectre, et libérer tout son potentiel hybride.

   </p>
            <p className="text-lg font-quantico leading-relaxed mb-6">
Avec une approche du live particulièrement évolutive et épique, son histoire prend vie là où les frontières sont abolies. Une histoire où roulements de basses, nappes mystiques et kicks distordus opèrent en harmonie et joignent leurs forces dans une progression inlassable vers le point culminant, qui n’est qu’un avant-goût du suivant.
