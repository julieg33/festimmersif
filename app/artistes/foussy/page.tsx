...
export default function Foussy() {
  const artiste = {
    nom: "Foussy",
    image: "/foussy.jpg", // à remplacer

    soundcloud: "https://on.soundcloud.com/Tar0ouk15w7yzYrh6M",
    instagram: "https://www.instagram.com/foussyyy?utm_source=ig_web_button_share_sheet&igsh=MW9xajZ3cWo0dmJmbQ==",
...
Dans un monde où les frontières de la musique électronique s'étendent sans limites, Foussy vise à créer une expérience musicale nouvelle pour les oreilles curieuse à la recherche de sonorités psychédéliques.
Mélangeant des influences de la Bass Music, de la Techno/Tekno, ainsi que du Rock Progressif et de la musique ethnique dans sa globalité. Son projet vise à créer un nouveau type de musique hybride abouti.

   </p>
            <p className="text-lg font-quantico leading-relaxed mb-6">
Sur le dancefloor, vous trouverez des morceaux groovy et ethniques, avec une attention particulière à la chaleur de la musique.
Ses Livesets progressifs et psychédéliques vous feront voyager à travers les différents biomes de la musique électronique.
   </p>
