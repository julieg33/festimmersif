...
export default function flaemishlion() {
  const artiste = {
    nom: "Flæmish Lion",
    image: "/flaemishlion.jpg", // à remplacer

    soundcloud: "https://on.soundcloud.com/OHOyG2wkz5u7A7EyrB",
    instagram: "https://www.instagram.com/flaemishlion?utm_source=ig_web_button_share_sheet&igsh=dGgzaHlkbGllMzIz",
  ...
  <div className="max-w-screen-xl mx-auto flex flex-col lg:flex-row items-center gap-12 px-4 sm:px-6 lg:px-8">
    ...
    <div className="w-full lg:w-2/3 text-center lg:text-left">
      ...
      <p className="text-lg font-quantico leading-relaxed mb-6">
        Tantôt éthérée par ses mélodies et rythmes organiques, tantôt par sa puissance issue d’une mentale hybride, la musique résonne dans le corps et touche le coeur pour ressentir l’instant.
La profondeur des ambiances et atmosphères viennent chercher l’âme et les pensées qui dévorent.
La musique par Flæmish Lion est la langue des émotions et l'amplification de la vie sensible et intelligible 
