...
export default function Dica() {
  const artiste = {
    nom: "Dica",
    image: "/dica.jpg", // à remplacer

    soundcloud: "https://on.soundcloud.com/6xmVkl4TZNdewLKI5T",
    instagram: "https://www.instagram.com/dica.303?utm_source=ig_web_button_share_sheet&igsh=b2w2c3N4cnZ3amZ6",
...
Il y a bien des choses qu’on ne peut pas enlever à nos amis Bretons, et leur amour pour la fête libre et inconditionnelle en fait assurément partie. Cet amour-là, peu de gens le transmettent aussi bien que DICA derrière ses machines.
De l’engouement des premières teufs il y a un peu plus de 10 ans à ses perfor- mances live d’aujourd’hui, il faut dire que l’artiste Rennais semble avoir fait un bon bout de chemin.

   </p>
            <p className="text-lg font-quantico leading-relaxed mb-6">
Fortement influencé par les vibrations acid émanant de l’autre côté de la Manche, c’est à travers l’acid UK et des labels phares du mouvement qu’il trouve l’impulsion pour créer sa propre musique, et très vite s’armer de tout un panel de machines.

   </p>
            <p className="text-lg font-quantico leading-relaxed mb-6">
Rythmiques groovy, TB303 frénétiques... Des influences qu’on retrouve quelques années plus tard mêlées à des sonorités goa et une bassline trance surboostée, au sein d’un live hardware terriblement bien huilé. Un univers sonore si bien taillé qu’il trouve aujourd’hui sa place sur des labels comme Fluctuat Rec, KTK, Recollection, SCTR ou encore Stay Up Forever... La boucle est bouclée.
