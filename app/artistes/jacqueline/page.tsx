...
export default function Jacqueline() {
  const artiste = {
    nom: "Jacqueline",
    image: "/jacqueline.jpeg", // à remplacer

    soundcloud: "https://on.soundcloud.com/6xaLkQ77nU5itdXm4i",
    instagram: "https://www.instagram.com/jesuisjacqueline_?utm_source=ig_web_button_share_sheet&igsh=MW1zbGRnNHZqaXRzaw==",
...
Jacqueline c’est l’élégance du groove et l’insolence du beat. Voyage aux sonorités mélodieuses, explosives et hypnotiques aussi bien solaires que sombres, elle mène la barque entre 125 et 130Bpm pour une atmosphère excitante, qui donne envie de danser jusqu’au petit matin. Elle ne suit pas la tendance, elle la twiste en talons. 
      </p>
