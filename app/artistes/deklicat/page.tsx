...
export default function Deklicat() {
  const artiste = {
    nom: "Deklicat",
    image: "/deklicat.png", // à remplacer

    soundcloud: "https://on.soundcloud.com/fUEuevtu3A74AYocSu",
    instagram: "https://www.instagram.com/deklicat?utm_source=ig_web_button_share_sheet&igsh=YTdyMDdjOWc3bGtt",
          ...
          <div className="max-w-screen-xl mx-auto flex flex-col lg:flex-row items-center gap-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="w-full lg:w-2/3 text-center lg:text-left">
              ...
              <p className="text-lg font-quantico leading-relaxed mb-6">
                Bercée depuis toute petite par la musique new wave et rock , et depuis quelques années surtout par les musiques électroniques, ce n’est que logiquement qu’elle s’est tournée vers le mix techno en 2020.
                Ce qui l’anime, elle, c’est plutôt la techno minimale bien mélodique avec un côté mélancolique tout en étant à la fois rythmée et dansante, mais surtout, qui hérisse le poil. « Une techno transcendante », c’est ce qui a pu être entendu.

              </p>
              <p className="text-lg font-quantico leading-relaxed mb-6">
                Entre noirceur et douceur, n'oubliant jamais harmonie et mélodie sur fond de BPM brut, elle vous embarquera pour un joli voyage toujours dynamique, qui vous touchera et vous fera danser au plus profond de vous. Chacun de ses sets est une histoire qu’elle veut raconter, son histoire à elle, qui la représente, mais aussi celle de tout un chacun.
