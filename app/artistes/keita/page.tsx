...
<main className="flex-grow pt-20 sm:pt-24 lg:pt-28">
  ...
  <div className="max-w-screen-xl mx-auto flex flex-col lg:flex-row items-center gap-12 px-4 sm:px-6 lg:px-8">
    ...
    <div className="w-full lg:w-2/3 text-center lg:text-left">
      ...
      <p className="text-lg font-quantico leading-relaxed mb-6">Membre du label shz records, keita est un jeune producteur émergent qui produit de la mental / hybride sur ableton. Il découvre les soirées tekno et les rave party en 2019, et tombe très vite amoureux du style musical qui en ressort, plus particulièrement de l’acid ainsi que de la mental tekno.
Il commence à produire ses premières créations musicales lors du confinement de 2020, voyant cette opportunité pour exprimer sa créativité ainsi que sa vision de la musique à travers la M.A.O.</p>
      <p className="text-lg font-quantico leading-relaxed mb-6">Il puise ses inspirations dans l’univers nippon ainsi que le dark fantasy. Avec une direction artistique très marquée pour les univers sombres et dérangeants, son sound design mêle groove obscur, mélodies entraînantes et sonorités expérimentales.
Dernièrement, il s’oriente de plus en plus vers l’industrial tekno, tout en incorporant des touches d’autres styles qu’il affectionne.
</p>
