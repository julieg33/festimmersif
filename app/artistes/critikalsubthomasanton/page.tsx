...
export default function critikalsubthomasanton() {
  const artiste = {
    nom: "Critikal sub & Thomas Anton",
    image: "/critikalsubthomasanton.jpg", // à remplacer
    soundcloud: "https://on.soundcloud.com/0wWK7mFIc0Jb8Wj9Oz",
    instagram: "https://www.instagram.com/critikal_sub_david?utm_source=ig_web_button_share_sheet&igsh=cW5tanFmYjZhc2s3"
...
Critikal Sub et Thomas Anton vous plongeront dans un contraste fascinant dans leurs créations musicales.
Une connexion live magique qui va vous transporter dans un univers mêlant dub, reggae, allant même jusqu’à la Techno ! 
Pour l'occasion ils joueront leurs toutes dernières exclusivités fraichement sortit de studio.
