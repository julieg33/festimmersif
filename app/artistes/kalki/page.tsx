...
export default function Kalki() {
  const artiste = {
    nom: "Kalki",
    image: "/kalki.jpg", // à remplacer

    spotify: "https://open.spotify.com/intl-fr/artist/5WCWKVOVoAEY3l3AHAiDql?si=cdrrUEsCTvWTdjmk3B7nLw",
    soundcloud: "https://on.soundcloud.com/kH2IBmkW0mEd6t4cMs",
    instagram: "https://www.instagram.com/kalkimusic?utm_source=ig_web_button_share_sheet&igsh=ZDIzaTJweDBwbHk3",
...
KALKI est un producteur de musique expérimenté originaire de France, qui façonne une musique électronique subtile depuis plus de dix ans.
Il est apparu sur la scène trance en 2016 avec la sortie de son premier EP Varanasi, illustré par un clip captivant tourné en Inde par Basile Pierrat.
  </p>
            <p className="text-lg font-quantico leading-relaxed mb-6">

KALKI fait partie du label Techsafari Records et sort de nombreux EPs à succès qui atteignent le top 10 de Beatport, comme ses titres Maya, Whales ou Japan.
 Il a signé avec Infinite Booking Music pour le Brésil et a déjà partagé la scène avec des artistes comme Ace Ventura, Protonica et bien d'autres.
KALKI déploie un univers narratif et spirituel mêlant culture science-fiction, rites primitifs et expériences psychiques, qui résonne, bien au-delà du genre musical, avec l'ensemble du mouvement psytrance.
   </p>
