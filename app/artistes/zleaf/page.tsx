...
export default function zleaf() {
  const artiste = {
    nom: "Z-Leaf",
    image: "/z-leaf.jpg", // à remplacer

    spotify: "https://open.spotify.com/intl-fr/artist/2ogLLfLDnBbHkGkWnWff9C?si=2VmTlYR2R2C9mmStpxfd3w",
    soundcloud: "https://on.soundcloud.com/OP2pqlwAoWtid0odQE",
    instagram: "https://www.instagram.com/z_leaf.music?utm_source=ig_web_button_share_sheet&igsh=MThra2RyM2k2czliag==",
...
z-leaf est un jeune producteur innovant toujours fidèle à une musique groovy, pensée pour le dancefloor, il se concentre sur l’expression d’une énergie puissante et d’une émotion profonde dont il détient le secret.
Ses sets sont 100 % autoproduits et reçoivent toujours un accueil chaleureux de la part du public.

 </p>
            <p className="text-lg font-quantico leading-relaxed mb-6">
Ayant joué aux côtés de grands noms du genre comme djantrix, symbolic ou rikøn, il a également été reconnu par des acteurs influents d'autres sphères musicales : replayé par charlie sparks, mis en avant par clubbing tv, et ayant partagé la scène avec eczodia ou tars, z-leaf propose une vision innovante de la psytrance qui rassemble et fait vibrer tous les publics.
