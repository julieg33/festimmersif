...
export default function Jalaya() {
  const artiste = {
    nom: "Jalaya",
    image: "/jalaya.png", // à remplacer
    instagram: "https://www.instagram.com/alice_jalaya?utm_source=ig_web_button_share_sheet&igsh=MTRnajkya20zNzV5cQ==",
