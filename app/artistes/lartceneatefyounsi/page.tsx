...
export default function lartceneatefyounsi() {
  const artiste = {
    nom: "L\'Art Cène & Atef Younsi",
    image: "/lartceneatefyounsi.jpg", // à remplacer
    soundcloud_c: "https://on.soundcloud.com/iuCGO7cg64rSmA6ZKA",
    spotify_c: 'https://open.spotify.com/intl-fr/artist/3ioYFywSUX3Xaryak4ouSK?si=YPRKbGuhRrWnwfZPVuoPsA',
    instagram_c: "https://www.instagram.com/lart_cene?utm_source=ig_web_button_share_sheet&igsh=MW9hZ2MwcXo4Y2tzdA==",
    instagram_d: "https://www.instagram.com/atef_younsi_?utm_source=ig_web_button_share_sheet&igsh=MW45cGN0eHo0c3ZsMw==",
          ...
          <div className="max-w-screen-xl mx-auto flex flex-col lg:flex-row items-center gap-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="w-full lg:w-2/3 text-center lg:text-left">
              ...
              <p className="text-lg font-quantico leading-relaxed mb-6">
                ...
                Difficile à définir, la musique de L'Art Cène se veut expérimentale et initiatique. Mêlant habilement la techno à l'étrange, il aime créer un malaise, susciter des interrogations, comme une invitation à sombrer dans les abysses de son univers musical.

              </p>
              <p className="text-lg font-quantico leading-relaxed mb-6">

                L'Art Cène est avant tout une démarche artistique, qui se veut personnelle, introspective et torturée. Chasseur de sons, il aime les capter, d'un cri strident au son d'une porte qui grince, tout devient matière musicale à retravailler sans cesse.
                Retrouvez-le sur la scène Fractal pour un live endiablé en compagnie d’Atef Yonsi !
              </p>
