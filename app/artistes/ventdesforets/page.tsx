...
export default function ventdesforets() {
  const artiste = {
    nom: "Vent des Forets",
    image: "/ventdesforets.jpg", // à remplacer

    soundcloud: "https://on.soundcloud.com/7DmAfLhKDn4A2qvSDF",
    instagram: "https://www.instagram.com/__ventdesforets?utm_source=ig_web_button_share_sheet&igsh=ZTAzaGp1aXF1M3Fp",
