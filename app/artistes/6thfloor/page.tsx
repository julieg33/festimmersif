...
export default function sixthfloor() {
  const artiste = {
    nom: "6thfloor",
    image: "/6thfloor.jpg", // à remplacer

    soundcloud: "https://on.soundcloud.com/X9Ao1toiHOz5Eazyok",
    instagram: "https://www.instagram.com/6thfloor_303?utm_source=ig_web_button_share_sheet&igsh=c3Ywczg3ZzJwbGhp",
...
6thFloor est un DJ et producteur français de techno underground et d’acid waves depuis 2012. Issu du mouvement free party avec le sound system Euphorik, il crée en 2018 son propre label vinyle Synthetic Line Records avec Level5. Parallèlement, il a produit d’autres tracks pour Oxymor, Advise, Volkane, Chronozone et Reustlab. 
Récemment, il est également programmateur et organisateur du festival Zouav’Fest 

     </p>
         <p className="text-lg font-quantico leading-relaxed mb-6">
6thFloor a notamment joué dans les festivals Bogotrax (Colombie), Tribunion (Mexique), Fora de Tempo (Portugal), Universo Paralello (Brésil), Free Connection (CZ), mais aussi Funky Freaky, Festifl’Art et Son Libre (France). 
Parmi ses différentes dates, il a pu jouer aux côtés d’artistes tels que Carbon, Peter Groskreutz, Ash Roy, Breger, Sonico, Midilink, Audioflow, 69db, Miss Tick, Melusine, Dorian Parano, Tilda, Mamz’Hell ou encore Logic LFO. Il a également un projet techno B2B avec son meilleur ami Spootnik appelé Stellar Brothers.
