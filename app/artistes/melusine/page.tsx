...
export default function Melusine() {
  const artiste = {
    nom: "Melusine",
    image: "/melusine.jpg", // à remplacer

    soundcloud: "https://on.soundcloud.com/Gn5rF9mzJVQhHJplg9",
    instagram: "https://www.instagram.com/melusinedj?utm_source=ig_web_button_share_sheet&igsh=aXJxa25tZTlpeDY4",
...
Melusine, DJ féminine, engagée dans le mouvement Techno, des Raves fin 90 à aujourd’hui, elle a développé son art au gré de ses découvertes musicales et folles rencontres.


     </p>
         <p className="text-lg font-quantico leading-relaxed mb-6">
C’est une passionnée qui, passée du vinyl à traktor, prépare ses sets comme une potion magique qu’elle diffuse à son public telle une sorcière. Parmi les pionnières de la techno swing, elle s’est toujours démarquée par ses sets atypiques, des sons groovy, une basse ronde..Aujourd’hui elle continue de mêler ses coups de coeur refusant de s’enfermer dans un style... toujours tekno, toujours dancefloor !

     </p>  
     <p className="text-lg font-quantico leading-relaxed mb-6">
Elle se promène de bar en festival, de free-party en club, en France et en Europe (Milan, Londres,
Prague, Barcelone)… tant que le plaisir et la vibration restent aussi intenses !
     </p>
