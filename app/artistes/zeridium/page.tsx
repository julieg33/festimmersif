...
export default function Zeridium() {
  const artiste = {
    nom: "Zeridium",
    image: "/zeridium.jpg", // à remplacer

    soundcloud: "https://on.soundcloud.com/yk0KJnGB5r1uTP62JS",
    instagram: "https://www.instagram.com/zeridium?utm_source=ig_web_button_share_sheet&igsh=ZDJqeWpzOWFocm5r",
