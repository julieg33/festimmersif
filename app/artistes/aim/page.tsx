...
export default function Aim() {
  const artiste = {
    nom: "Aim",
    image: "/aim.jpg", // à remplacer

    soundcloud: "https://on.soundcloud.com/m97mrfzIh3lEVkV7EH",
    instagram: "https://www.instagram.com/i_aim?utm_source=ig_web_button_share_sheet&igsh=MWtiZzByNXg5eWc3bA==",
...
Après être passé par la Discomix DJ School, Aim fait ses armes en free party ou il explore un large spectre musicale, du Dubstep à la Hardtek en passant par la Psytrance, ce qui lui permet d’affiner d’année en année le choix de son groove, qui va se porter au final sur des sonorités Techno / Prog, gravitant autour des 128-133 BPM.

     </p>
         <p className="text-lg font-quantico leading-relaxed mb-6">
N'écoutant que ses "autres lui" lorsqu'il s'agit d'imaginer quelque chose d'innovant, la linéarité n'est pas sa ligne de conduite. Aim ravit toujours lors de ses prestations des plus extraverties.
Son univers est euphorique, optimiste et il sait mieux que personne comment le transmettre ! 
     </p>
