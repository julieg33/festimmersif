...
export default function Mimix() {
  const artiste = {
    nom: "Mimix",
    image: "/mimix.jpg", // à remplacer
    instagram: "https://www.instagram.com/mimix.akph?utm_source=ig_web_button_share_sheet&igsh=cTE1bzZvYzV1dXkz",
