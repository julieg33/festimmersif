...
export default function Hugo() {
  const artiste = {
    nom: "Roots Zombie",
    image: "/rootszombie.jpg", // à remplacer
    soundcloud: "https://open.spotify.com/intl-fr/artist/5EuToKPPl4hmqXj04uFGci?si=LnjGcztxQW60M5uM8nH6cQ",
    instagram: "https://www.instagram.com/rootszombie?utm_source=ig_web_button_share_sheet&igsh=bDkzOXI1d2dxdHh6",
...
<main className="flex-grow pt-20 sm:pt-24 lg:pt-28">
  ...
  <div className="max-w-screen-xl mx-auto flex flex-col lg:flex-row items-center gap-12 px-4 sm:px-6 lg:px-8">
    ...
    <div className="w-full lg:w-2/3 text-center lg:text-left">
      ...
      <p className="text-lg font-quantico leading-relaxed mb-6">Roots Zombie c’est la rencontre entre un producteur de musique électronique et un bassiste Dub. 
Issus du Punk, ils qualifient leur style d’Electro Voodoo Dub alliant Reggae, Techno et World Music.
En 2017 le duo signe l’album Soundz From The House sur le label ODG PROD, puis Dub Highway en 2022 chez Culture Dub, avant de proposer leur premier EP autoproduit Bad Drivers en 2024.
Aussi à l’aise sur scène qu’en sound system, Roots Zombie continue de multiplier les projets et concerts, mêlant machines, basse et guitare en live.
</p>
