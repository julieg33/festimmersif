...
export default function polette() {
  const artiste = {
    nom: "Polette de la nuit",
    image: "/polette.jpg", // à remplacer

    soundcloud: "https://on.soundcloud.com/zCnhDPmredeRbJcyfB",
    instagram: "https://www.instagram.com/polettedelanuit?utm_source=ig_web_button_share_sheet&igsh=bnhrMjhlcHllMnZm",
...
Polette de la Nuit "Du groove sous les étoiles." 
DJ féminine emblématique du Sud-Ouest
Son style navigue entre trance progressive planante et grooves puissants, offrant des sets hypnotiques, intenses et toujours imprévisibles. Elle s’est imposée dans les clubs, les festivals et surtout dans le circuit rave, où son nom est aujourd’hui reconnu pour sa capacité à retourner un dancefloor. Préparez-vous à plonger dans son univers sonore. 
    </p>
