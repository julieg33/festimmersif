...
export default function Clitorock() {
  const artiste = {
    nom: "Clitorock",
    image: "/clitorock.jpg", // à remplacer

    soundcloud: "https://on.soundcloud.com/As4xdMs8Wk8KSfCWM1",
    instagram: "https://www.instagram.com/clitorock?utm_source=ig_web_button_share_sheet&igsh=a2ZnbnZvYWs1dGI0",
...
Ses DJ SET sont réfléchis pour donner plus de visibilité aux productrices dans la musique électronique et surtout pour vous faire lâcher prise autour d'une progressive psytrance torrentueuse. 
Son objectif ? Vous permettre de vous évader tout en faisant passer des messages. Elle récolte vos revendications et vos rêves sous forme d'audios afin de les incorporer avec soin à ses DJ sets*. La psytrance renforce alors le pouvoir de chaque mot tandis que les messages audios ajoutent une profondeur à chaque note, créant une puissante synergie.
À travers ses DJ SETS participatifs* elle donne de la résonance à des voix qui ne sont pas toujours écoutées et à des messages qui la font vibrer en espérant vous faire vibrer aussi. 
 Son rêve : Permettre aux corps de s’évader et aux cœurs de s'ancrer collectivement en transformant nos émotions individuelles en révolte collective.
    </p>
