...
export default function Eneris() {
  const artiste = {
    nom: "Eneris",
    image: "/eneris.jpg", // à remplacer

    instagram: "https://www.instagram.com/eneris___?utm_source=ig_web_button_share_sheet&igsh=eXR4OXZ4ejh1bThr",
...
ΞИΞЯIS vit au rythme de l'océan et de la culture underground. Membre et fondatrice de l’association Eco-Seastem elle allie donc ses 2 passions sur des événements musicaux qui ont pour objectif de sensibiliser à la protection des océans. C'est en free party lors d'un surftrip en Australie qu'elle a découvert la tekno et la psytrance qui ont radicalement changé sa vie et dirigé son style musical.
Pour elle, le son et les basses sont capables de transmettre une énergie puissante, pour vous plonger au plus profond de son univers. Lors de sets de mental tekno, acidtekno, acidcore. Darkminimal/psytechno, ou psyprog/psytrance vous nagerez à travers différentes ambiances amenées par des mélodies, des voix, ou des rythmes variés. Son goût particulier pour les sonorités acides et ethniques vous feront voyager entre eaux turquoises et eaux troubles.
