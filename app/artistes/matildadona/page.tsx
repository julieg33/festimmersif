...
export default function matildadona() {
  const artiste = {
    nom: "Matilda Dona",
    image: "/matildadona.jpg", // à remplacer
    instagram: "https://www.instagram.com/matildadona_?utm_source=ig_web_button_share_sheet&igsh=MWJnMXhhZ240dWlp",
...
Dub addict depuis plus d'une dizaine d’années, Matilda commence à collectionner les vinyls début 2020. Encouragée par ses ami.e.s (Meladub, Erinejah, Peeny Wally, Neboty
Roots, Snoww Dub, Blissful Dub..) elle commence à sélecter durant le confinement.

      </p>
            <p className="text-lg font-quantico leading-relaxed mb-6">
Depuis elle a joué sur une 60aine d'événements en France, en Suisse, au Portugal et en Espagne soutenue par de nombreux acteurs du milieu et amis: Garladub, Selecta Spirit, RDS, Pastek Frequencies, Petah Higrade, Catharsis, Uzly Hifi, Asher Selector...
Avec une sélection allant du Roots au stepper, Matilda aime faire voyager son public à travers les styles. Une devise: Good vibes !
