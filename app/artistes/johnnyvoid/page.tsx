...
export default function johnnyvoid() {
  const artiste = {
    nom: "Johnny Void",
    image: "/johnnyvoid.jpg", // à remplacer

    soundcloud: "https://on.soundcloud.com/TCOBnFPLnUjgfYE0cM",
    instagram: "https://www.instagram.com/johnnyvoid_live?utm_source=ig_web_button_share_sheet&igsh=MXBxZjh0YTRlem1scQ==",
