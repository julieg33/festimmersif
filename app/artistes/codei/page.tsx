...
export default function codei() {
  const artiste = {
    nom: "Cødeî",
    image: "/codei.jpg", // à remplacer

    instagram: "https://www.instagram.com/petit__greg?utm_source=ig_web_button_share_sheet&igsh=MW56aHA2Nmh3OHpxNw==",
