    ...
    <div className="relative min-h-screen bg-black text-white">
      ...
      <div className="relative w-full pt-20 sm:pt-24">
        ...
        <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
          <motion.h1 initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="text-5xl md:text-6xl text-center text-white font-turret absolute top-[13%] sm:top-[30%]">
            Mentions légales
          </motion.h1>
          <motion.h1 initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="text-5xl md:text-6xl text-center text-white font-turret absolute top-[20%] sm:top-[37%]">
            &
          </motion.h1>
          <motion.h1 initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="text-5xl md:text-6xl text-center text-white font-turret absolute top-[27%] sm:top-[44%]">
        ...
        <div className="container mx-auto flex flex-col items-center w-full">
          <div className="w-full md:w-5/6 text-left">
            <div className="flex items-center justify-center mb-10">
              <h2 className="text-4xl text-[#9ec37b] font-bebasNeue text-center">Mentions légales</h2>
            </div>

            <div className="text-lg font-quantico leading-relaxed space-y-6">
              <div>
                <h3 className="text-2xl text-[#9ec37b] font-bebasNeue mb-2">Éditeur du site</h3>
                <p>
              ...
              <div>
                <h3 className="text-2xl text-[#9ec37b] font-bebasNeue mb-2">Hébergeur du site</h3>
                <p>
                  ...
                  <br />
                  Site web : <a href="https://vercel.com" target="_blank" rel="noopener noreferrer" className="text-[#9ec37b] hover:text-green-700">https://vercel.com</a>
                  <br />
              ...
              <div>
                <h3 className="text-2xl text-[#9ec37b] font-bebasNeue mb-2">Propriété intellectuelle</h3>
                <p>
              ...
              <div>
                <h3 className="text-2xl text-[#9ec37b] font-bebasNeue mb-2">Données personnelles</h3>
                <p>
              ...
              <div>
                <h3 className="text-2xl text-[#9ec37b] font-bebasNeue mb-2">Cookies</h3>
                <p>
